    ...
    <div class="logo">
        <a href="javascript:void(0);" class="text-center" style="margin-bottom: 11px">
            <div class="text-center">
                <img src="<?php echo e(asset('images/Logo_VE3000.png')); ?>" style="vertical-align: middle" alt="" height="90">
            </div>
...
unset($__errorArgs, $__bag); ?>"
                           type="text" autocomplete="off" placeholder="Email" name="email" value="<?php echo e(old('email')); ?>"
                        <?php echo e(!old('email') ? 'autofocus' : null); ?>/>
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="input-group mb-3" :class="[errors.has('password') ? 'has-error' : '']">
                    <input type="password" name="password"
                           class="form-control placeholder-no-fix <?php $__errorArgs = ['password'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
<?php /**PATH /var/www/backend/Modules/Backend/Resources/views/layouts/login.blade.php ENDPATH**/ ?>