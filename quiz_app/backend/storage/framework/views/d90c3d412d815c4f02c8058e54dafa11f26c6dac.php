<?php $__env->startSection('title', 'Quản lý slide'); ?>
            ...
            <div class="tab-content tab-content-customize">
                <div class="tab-pane fade show active">
                    <div class="card-body">
                        <div class="row">
                            <div class="col-md-12">
                                <table class="table table-bordered table-striped" id="slider-table">
                                    <thead>
...
<?php $__env->startSection('script'); ?>
    <script>
        $('body').on('click', '.change-status', function () {
            ...
            let id = $(this).data('id');
            $.ajax({
                url: APP_URL + '/slider-update-status/'+id,
                type: 'POST',
                data: {status: status},
        ...
        let category = function () {
            let initSliderTable = function () {
                if (!jQuery().dataTable) {
                    return;
                }
                let table = $('#slider-table');
...
<?php echo $__env->make('backend::layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/backend/Modules/Backend/Resources/views/sliders/index.blade.php ENDPATH**/ ?>