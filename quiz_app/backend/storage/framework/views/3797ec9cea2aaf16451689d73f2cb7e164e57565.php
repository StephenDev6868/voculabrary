                    ...
                    <div class="col-12">
                        <div class="form-group">
                            ...
                            <input type="file" class="dropify" id="logo" name="logo" accept="image/*"
                                   <?php echo e(isset($aboutUs) ? '' : ''); ?>

                                   data-default-file="<?php echo e(isset($aboutUs->logo) ? getUrlFile($aboutUs->logo) : null); ?>">
                        </div>
                    </div>
                    <div class="col-12">
                        <div class="form-group">
                            <label for="app-version">Logo</label>
                            <input type="text" class="form-control" id="app-version" name="app_version" value="<?php echo e(isset($aboutUs->app_version) ? $aboutUs->app_version : '1.0.0'); ?>">
                        </div>
                    </div>
...
<?php /**PATH /var/www/backend/Modules/Backend/Resources/views/about-us/_form.blade.php ENDPATH**/ ?>