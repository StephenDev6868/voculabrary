...
<?php $__env->startSection('script'); ?>
    <script>
        $('body').on('click', '.change-status', function () {
            ...
            let id = $(this).data('id');
            $.ajax({
                url: APP_URL + '/account-update-status/'+id,
                type: 'POST',
                data: {status: status},
...
<?php echo $__env->make('backend::layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/backend/Modules/Backend/Resources/views/accounts/index.blade.php ENDPATH**/ ?>