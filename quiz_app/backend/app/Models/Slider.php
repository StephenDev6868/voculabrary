...
class Slider extends Model
{
    ...
    {
        return '<a class="btn-action btn btn-color-blue btn-icon btn-sm" title="Sửa" href="' .route('slider.edit',$this->id).'"><i class="fa fa-edit"></i></a>
    ...
    public function getType()
    {
        if ($this->type == 1) {
            ...
            return '<small class="badge badge-info">Trang chủ</small>';
        } elseif ($this->type == 2) {

            return '<small class="badge badge-info">Danh mục</small>';
        } else {
